...
[REPETICIONES,ITERACIONES,L,N,A_POTENCIAL,ALFA_POTENCIAL,R,DELTA_AVANCE,DELTA_ROTACION,W,SIGMA_ROTACION,SIGMA_A_POTENCIAL,R_COLISION,ACTIVAR_GRAFICOS,TAM_IDENTIFICADOR]=CargaParametros();
...
while cr<REPETICIONES + 1
    ...
    while ci<ITERACIONES + 1 && Exito(robots,N)
        ...
        robots=RotacionAvance(robots,DELTA_ROTACION,N,W,ALFA_POTENCIAL,DELTA_AVANCE,SIGMA_ROTACION,SIGMA_A_POTENCIAL);
        ci=ci+1;
    end
    if ACTIVAR_GRAFICOS
        for i=1:N
